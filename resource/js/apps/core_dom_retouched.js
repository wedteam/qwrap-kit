(function() {
	...
	document.write('<script type="text/javascript" src="' + srcPath + 'core/device.js"><\/script>');
	...
	document.write('<script type="text/javascript" src="' + srcPath + 'dom/selector_w3c.js"><\/script>');
