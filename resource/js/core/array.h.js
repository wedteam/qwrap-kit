...
(function() {
	...
	var ArrayH = {
		...
		forEach: function(arr, callback, pThis) {
			var args = [].slice.call(arguments, 1);
			return Array.prototype.forEach.apply(arr, args);
		},
		...
		some: function(arr, callback, pThis) {
			var args = [].slice.call(arguments, 1);
			return Array.prototype.some.apply(arr, args);
		},
		...
		every: function(arr, callback, pThis) {
			var args = [].slice.call(arguments, 1);
			return Array.prototype.every.apply(arr, args);
		},
		...
		indexOf: function(arr, obj, fromIdx) {
			var args = [].slice.call(arguments, 1);
			return Array.prototype.indexOf.apply(arr, args);
		},
		...
		lastIndexOf: function(arr, obj, fromIdx) {
			var args = [].slice.call(arguments, 1);
			return Array.prototype.lastIndexOf.apply(arr, args);
		},
